...
export default function AnnouncementComp(x){
            ...
            }
            {
                ...
                <View style={{opacity : (optionsModel == false && deletePost == x.data.postID && deletePost != null) ? 0.25 : 1}} >
                    ...
                    <View style={{opacity : (optionsModel == false && ( x.data.postType == "share" ? deletePost == x.data.sharedPostData._id : deletePost == x.data._id ) && deletePost != null) ? 0.25 : 1}}>
                        <View style={{minHeight:height/5.7, width:width/1.23, backgroundColor:"white", borderTopLeftRadius:26, borderTopRightRadius:26, elevation:3,borderLeftColor:"grey",borderLeftWidth:0.3, borderRightColor:"grey",borderRightWidth:0.3}}>
                            <View style={{marginLeft:width/27, marginTop:height/59, flexDirection:"row"}} >
                                ...
                                <View style={{justifyContent:"center", marginLeft:7, flex:3}} >
                                    <Text style={{fontWeight:"bold", fontSize:13.3, color:"black"}}>
                                        {x.data.postType == "share" ? x.data.postUserData.userName : x.data.userData.userName }
                                        <Text style={{color:"grey", fontWeight:"normal"}}> has an <Text style={{fontWeight:"bold" , color:"black"}}>Announcement</Text> about</Text> 
                                        <Text style={{color:"red"}}> {x.data.postType == "share" ? x.data.sharedPostData.title :  x.data.title }</Text> <Text style={{color:"grey"}} >!</Text>
                                    </Text>
                            ...
                            <View style={{marginVertical:height/35, marginHorizontal:width/20}} >
                                <Text style={{color:"black", fontWeight:"bold", fontSize:20}}>{x.data.postType == "share" ?  x.data.sharedPostData.announcement :  x.data.announcement }</Text>
                            </View>
                    ...
                    <Modal visible={likesModelVisible} transparent animationType="slide" >
                        <View style={{flex:1, backgroundColor:"rgba(9,9,0,0.5)", alignItems:"center", justifyContent:"flex-end"}}>
                                        ...
                                        <View style={{flex:1}} >
                                            ...
                                            <View style={{marginBottom:15, flexDirection:"row", alignItems:"flex-end", flex:1, justifyContent:"center"}} >
                                                <TextInput 
                                                    ...
                                                    />
                                                <TouchableOpacity style={{width:width/6,backgroundColor:"yellow",borderRadius:20, marginLeft:10, justifyContent:"center",alignItems:"center", height:height/18.3}} onPress={postComment} >
                    ...
                    <Modal visible={shareModel} transparent >
                        <View style={{flex:1, backgroundColor:"rgba(9,9,0,0.85)", alignItems:"center", justifyContent:"center", height:100}}>
                            <View style={{minHeight:height/5, width:width/1.23, backgroundColor:"white", borderRadius:26, elevation:3,borderLeftColor:"grey",borderLeftWidth:0.3, borderRightColor:"grey",borderRightWidth:0.3}}>
                                <View style={{marginLeft:width/27, marginTop:height/59, flexDirection:"row"}} >
                                    <TouchableOpacity>
                                        <Image 
                                            source={{uri: x.data.postType == "share" ? x.data.postUserData.avatar : x.data.userData.avatar }}
